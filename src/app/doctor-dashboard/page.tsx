...
import {
  ...
  MailPlus,
  Search,
} from 'lucide-react'; // 2. Importar o ícone de Busca
...
import { InviteByPhoneModal } from './invite-by-phone/page';
      ...
      <>
        ...
        <div className="flex flex-col items-center justify-center p-8 text-center">
          ...
          <p className="text-muted-foreground">
            Esta área é destinada apenas para usuários com perfil de médico.
          </p>
        </div>
      </>
    );
                  ...
                  <TableRow key={user.uid}>
                    ...
                    <TableCell className="text-right">
                      <Button asChild variant="outline" size="sm">
                        <Link
                          href={`/doctor-dashboard/user-dashboard/${user.uid}`}
                        >
